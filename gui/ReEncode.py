...
def Reencode(window):
    if not window.running:
        ...
        window.tabWidget.setTabText(3, "*Re-encode")

        window.ree_output_console.setHtml("")  # clearing the output_console
        ...
        for video in VidsToRender:
            if os.path.isfile(os.path.splitext(video)[0] + append):
                ...
                window.process_start(cmd, window.ree_output_console)
