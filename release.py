...
lstupdt = "2023-10-26"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "testing"
ver = "2.2.1.9"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
