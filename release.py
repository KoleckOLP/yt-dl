...
lstupdt = "2025-09-01"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "Threading3"
ver = "2.2.4.0-dev1"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
