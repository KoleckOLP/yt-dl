...
lstupdt = "2024-03-25"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "testing"
ver = "2.2.2.1"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
