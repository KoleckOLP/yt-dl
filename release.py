...
lstupdt = "2025-05-12"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "testing"
ver = "2.2.3.1_BETA"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
