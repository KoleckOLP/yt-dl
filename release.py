...
lstupdt = "2026-02-02"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "AI_Refactor"
ver = "2.2.4.1"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
