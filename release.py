...
lstupdt = "2024-11-10"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "threadding2"
ver = "2.3.0.0_BETA"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
