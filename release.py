...
lstupdt = "2023-04-01"  # Well now that it's in a separate file I should be updating it more often.
...
curb = "testing"
ver = "2.2.1.7"  # 2. python(language), 2. major(gigantic), 1. minor(big), 1 hotfix(small)
